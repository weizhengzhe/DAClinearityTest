...
public interface NNCalcController {
     ...
     * </pre>
     */
    void processEnterEvent(String portName);
     ...
     * </pre>
     */
    void processTestINL(String bitSelection);
    ...
    void processTestNonMonotonicRegion(String bitSelection);
